...
const translations = {
  en: {
    ...
    farmerDetailsDesc: 'For official records and PDF header',
    farmerNameLabel: 'Farmer Name',
    farmerMobileLabel: 'Mobile Number',
    farmerLocationLabel: 'Location',
    cancel: 'Cancel',
    generatePDF: 'Generate PDF',
    fillAllFields: 'Please fill all details',
  },
  te: {
    ...
    farmerDetailsDesc: 'అధికారిక రికార్డులు మరియు PDF హెడర్ కోసం',
    farmerNameLabel: 'రైతు పేరు',
    farmerMobileLabel: 'మొబైల్ సంఖ్య',
    farmerLocationLabel: 'నివాసం/ప్రాంతం',
    cancel: 'రద్దు చేయి',
    generatePDF: 'PDF డౌన్‌లోడ్ చేయండి',
  ...
  hi: {
    ...
    farmerDetailsDesc: 'आधिकारिक रिकॉर्ड और पीडीएफ हेडर के लिए',
    farmerNameLabel: 'किसान का नाम',
    farmerMobileLabel: 'मोबाइल नंबर',
    farmerLocationLabel: 'स्थान/पता',
    cancel: 'रद्द करें',
    generatePDF: 'पीडीएफ बनाएं',
    fillAllFields: 'कृपया सभी विवरण भरें',
  },
};
